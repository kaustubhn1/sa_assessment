...
from .views import PermissionApi, ReadProjectApi, ReadSingleProjectApi, CreateProjectApi, UpdateProjectApi
...
urlpatterns = [
    ...
    path('update_project_api/', UpdateProjectApi.as_view(), name="update_project_api"),
]
